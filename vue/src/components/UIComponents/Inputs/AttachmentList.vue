<template>
  <div class="file-upload">
    <div class="form-group">
      <label class="control-label">Listing <span
        class="label label-primary">Total Size: {{ (Number(upload_size / 1024 / 1024)).toFixed(2) }}MB</span></label>
      <br><br>
      <div class="form-group">
        <div class="form-group files">
          <div class="attachment-holder animated fadeIn" v-cloak v-for="(attachment, index) in attachments">
            <div class="form-group">
              <span class="label label-primary"><a target="_blank" class="link"
...
<script>
  ...
  export default {
    ...
    computed: {},
    methods: {
      removeServerAttachment (attachmentId) {
